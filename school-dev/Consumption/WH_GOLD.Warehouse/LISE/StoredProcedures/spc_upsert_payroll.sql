...
BEGIN
    ...
    USING (
        SELECT PersonnelID, Nom, Prenom, Periode, 
    ...
    WHEN NOT MATCHED THEN 
        INSERT (PaieID, PersonnelID, Nom, Prenom, Periode, Date, Montant, Devise, ProfessionTypeID,
                EtablissementID, ClasseID)
        VALUES (NEWID(), S.PersonnelID, S.Nom, S.Prenom, S.Periode, S.Date, S.Montant, S.Devise, S.ProfessionTypeID,
