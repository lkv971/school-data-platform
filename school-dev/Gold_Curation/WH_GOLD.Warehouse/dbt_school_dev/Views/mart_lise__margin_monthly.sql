...
create view "dbt_school_dev"."mart_lise__margin_monthly" as with payroll as (
    select * from "WH_GOLD"."dbt_school_dev"."mart_lise__payroll_monthly"
),
revenue as (
    select * from "WH_GOLD"."dbt_school_dev"."mart_lise__revenue_monthly"
),
payroll_agg as (
    select
        CalendarYear,
